...
public class ApiConstants {
    ...
    //Open API 변경
    public static final String OPEN_API_AUTH_HOST_ADDRESS = "http://220.90.216.70:8050";

    //public static final String OPEN_API_HOST_ADDRESS = "http://220.90.216.73:8080/masterapi/v1";        //masterapi host
    public static final String OPEN_API_HOST_ADDRESS = "http://220.90.216.70:8040/masterapi/v1";        //API-GW host


    public static final String OPEN_API_TEST_HOST_ADDRESS = "http://192.168.0.20:8080/masterapi/v1";

    //public static final String OPEN_API_CORE_HOST = "http://220.90.216.73:8180/coreapi/v1";
    public static final String OPEN_API_CORE_HOST = "http://220.90.216.70:8040/coreapi/v1";                  //API-GW event host
    public static final String OPEN_API_PUSH_HOST = "http://220.90.216.70:8040/pushapi/v1";                  //API-GW push host
    ...
    //Protocol API
    public static final String OPEN_API_GET_DEVICE_LIST = OPEN_API_HOST_ADDRESS + "/protocols?svcTgtSeq=%s&pageNum=%d&pageCon=%d";
    ...
    //Tag Stream API
    public static final String OPEN_API_GET_TAGSTREAM_LIST  = OPEN_API_HOST_ADDRESS + "/streams/%s/%s?pageNum=%s&pageCon=%s";
    public static final String OPEN_API_GET_TAGSTREAM_LOG = OPEN_API_HOST_ADDRESS + "/streams/%s/%s/log?period=%s&count=%s";
